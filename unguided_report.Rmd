---
title: "Unguided Factor Analysis on MCF10A Data"
...
```{r}
G0.go_enrich <-
  readRDS(paste0(wkdir, "gsfa_output/enrich_res/G0.corrected.k20_svd.go_enrich.rds"))
print_enrich_tb(G0.go_enrich)
```

## PIP cutoff at 0.9
```{r}
G0.go_enrich <-
  readRDS(paste0(wkdir, "gsfa_output/enrich_res/G0.corrected.k20_svd.go_enrich.cutoff_0.9.rds"))
print_enrich_tb(G0.go_enrich)
```
