...
scaled.gene_exp <- readRDS(paste0(wkdir, 'data/cropseq_dox.scaled_top8k_var.corrected_lib_size.rds'))
```
...
```{r}
All_KOs.gibbs_PM <-
  readRDS(paste0(wkdir, "gsfa_output_top8k_var/All.corrected.gibbs_obj_k20.svd.PM.rds"))
...
rand_1.gibbs_PM <- readRDS(paste0(wkdir,
                                  "gsfa_output_top8k_var/All.corrected.gibbs_obj_k20.rand_01.PM.rds"))
rand_2.gibbs_PM <- readRDS(paste0(wkdir,
                                  "gsfa_output_top8k_var/All.corrected.gibbs_obj_k20.rand_02.PM.rds"))
G0.gibbs_PM <-  readRDS(paste0(wkdir,
                               "gsfa_output_top8k_var/G0.corrected.gibbs_obj_k20.svd.PM.rds"))
```
...
```{r}
gsfa.go_enrich <-
  readRDS(paste0(wkdir, "gsfa_output_top8k_var/enrich_res/All_KOs.corrected.k20_svd.go_enrich.cutoff_0.5.rds"))
