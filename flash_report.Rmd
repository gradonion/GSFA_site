...
````{r}
flashier_obj <- readRDS(paste0(wkdir, "flash_output/corrected.gene_0.1.flashier_obj_k20.rds"))
...
flash.go_enrich <- readRDS(paste0(wkdir,
                                 "flash_output/enrich_res/corrected.flash_k20.go_enrich.rds"))
print_enrich_tb(flash.go_enrich)
```
