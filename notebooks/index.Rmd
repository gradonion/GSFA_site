...
* [Pseudotime trajectory analysis, similar to reference paper](LUHMES_pseudotime_trajectory.html);
* [GSFA, normal-mixture prior](LUHMES_merged_new.gsfa_dev_res_normal_mixture.html);
* [GSFA, normal-mixture prior, cells analyzed by early and late stages](LUHMES_by_groups.gsfa_dev_res_normal_mixture.html);
* [GSFA, spike-and-slab prior, 4 confounding factors corrected](LUHMES_merged_new.gsfa_all_markers_detect_01.html);
* [Enrichment analysis on GSFA result (spike-and-slab)](LUHMES_merged_new.gsfa_all_markers_detect_01_enrichment.html);
* [Gene discovery using LFSR, and comparison with DGE (spike-and-slab)](LUHMES_lfsr.html);
* [Permutation results (spike-and-slab)](LUHMES_merged_new.permutation_detect_01.html);
...
* [Clustering analysis of all cells, similar to reference paper](All_TCells_clustering.html);  
[GSFA, normal-mixture prior, donor not corrected, cells analyzed by group ](All_TCells_uncorrected.gsfa_dev_res_normal_mixture_by_group.html);  
[GSFA, normal-mixture prior, donor corrected, cells analyzed by group ](All_TCells_donor_corrected.gsfa_dev_res_normal_mixture_by_group.html);  
...
[GSFA, normal-mixture prior](Stimulated_TCells_merged.gsfa_dev_res_normal_mixture.html);  
[GSFA, spike-and-slab prior](Stimulated_TCells_merged.gsfa_all_genes_detect_01.html);  
[Enrichment analysis on GSFA result (spike-and-slab)](Stimulated_TCells_merged.enrichment_gsfa_detect_01.html);  
...
[GSFA, normal-mixture prior](Unstimulated_TCells_merged.gsfa_dev_res_normal_mixture.html);  
[GSFA, spike-and-slab prior](Unstimulated_TCells_merged.gsfa_all_genes_detect_01.html);
