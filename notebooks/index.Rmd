...
* [GSFA, normal-mixture prior on W](LUHMES_merged_new.gsfa_dev_res_normal_mixture.html);
* [GSFA, spike-and-slab prior on W, 4 confounding factors corrected](LUHMES_merged_new.gsfa_all_markers_detect_01.html);
...
* [Permutation results](LUHMES_merged_new.permutation_detect_01.html);
* [(GSFA, 3 confounding factors corrected)](LUHMES_merged.gsfa_all_markers_detect_01.html);
...
[GSFA, normal-mixture prior on W, donor batch not corrected](All_TCells_uncorrected.gsfa_dev_res_normal_mixture_by_group.html);  
[GSFA, normal-mixture prior on W, donor batch corrected](All_TCells_donor_corrected.gsfa_dev_res_normal_mixture_by_group.html);  
...
[GSFA, normal-mixture prior on W](Stimulated_TCells_merged.gsfa_dev_res_normal_mixture.html);  
[GSFA, spike-and-slab prior on W](Stimulated_TCells_merged.gsfa_all_genes_detect_01.html);  
...
[GSFA, normal-mixture prior on W](Unstimulated_TCells_merged.gsfa_dev_res_normal_mixture.html);  
[GSFA, spike-and-slab prior on W](Unstimulated_TCells_merged.gsfa_all_genes_detect_01.html);
