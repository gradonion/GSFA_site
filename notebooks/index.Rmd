...
For a given normalizd gene expression matrix $Y \in \mathbb{R}^{N \times P}$ and a guide matrix $G \in \mathbb{R}^{N \times M}$ that holds $M$ types of sample-level conditions:
