...
Neuron progenitor (NPC): NES, TP53, CDK4  
Post-mitotic neuron: MAP2, DCX  
...
all_moi_df1 <- data.frame(
  protein_name = c("VIM", "NES", "SOX2", "TP53", "CDK4", "MAP2", "DCX", "GAD1", "GAD2", "SLC17A6", "DAT1",
  "FOXG1", "BRN2", "EBF1", "SERTAD4", "TBR1", "NPY", "SST", "DLX2", "DLX5", "SATB2", "CBLN2", "CUX2", "NEFM"),
  gene_name = c("VIM", "NES", "SOX2", "TP53", "CDK4", "MAP2", "DCX", "GAD1", "GAD2", "SLC17A6", "SLC6A3",
...
MAP1B: highly expressed during neural development in actively extending axons
ZEB2: a transcription factor that regulates neuron development 
```{r list_of_neuron_proj_genes}
all_moi_df2 <- data.frame(
  protein_name = c("DPYSL3", "HSPA5", "CRMP1", "CRABP2", "CCDC88A", "UBE2V2", "MAPT", "NEFL", "MEF2C", "ZEB2",
                   "MAP1B", "ITM2C", "CNTN2", "ACAP3", "FKBP4", "GSK3B", "EFNA5", "SERPINF1"),
  gene_name = c("DPYSL3", "HSPA5", "CRMP1", "CRABP2", "CCDC88A", "UBE2V2", "MAPT", "NEFL", "MEF2C", "ZEB2",
                   "MAP1B", "ITM2C", "CNTN2", "ACAP3", "FKBP4", "GSK3B", "EFNA5", "SERPINF1")
)
...
```{r GO_term_heatmap, fig.height=11, fig.width=9}
