...
## `WebGestalt` GO Slim Over-Representation Analysis
...
gsfa.Web_ORA_go_bp <-
  readRDS(paste0(wkdir, gsfa_folder,
                 "ORA_GO/All.gibbs_obj_k20.svd.WebGestalt_go_bp.cutoff_0.95.rds"))
...
## `WebGestalt` KEGG Pathway Over-Representation Analysis

Target: Genes w/ non-zero loadings in each factor (PIP cutoff at 0.95);    
Backgroud: all 6062 genes used in factor analysis;    
Statistical test: hypergeometric test;    
...
gsfa.Web_ORA_kegg <-
  readRDS(paste0(wkdir, gsfa_folder,
                 "ORA_GO/All.gibbs_obj_k20.svd.WebGestalt_pathway_KEGG.cutoff_0.95.rds"))
...
## `WebGestalt` Wikipathway Over-Representation Analysis
...
gsfa.Web_ORA_wiki <-
  readRDS(paste0(wkdir, gsfa_folder,
                 "ORA_GO/All.gibbs_obj_k20.svd.WebGestalt_pathway_Wikipathway.cutoff_0.95.rds"))
