...
```{r out.width = "100%"}
knitr::include_graphics("figs/cirgo_large_all_factors.svg")
```

### Terms in Factor 7

```{r out.width = "100%"}
knitr::include_graphics("figs/cirgo_large_factor_7.svg")
```
...
```{r out.width = "100%"}
knitr::include_graphics("figs/cirgo_large_factor_8.svg")
```
...
```{r out.width = "100%"}
knitr::include_graphics("figs/cirgo_large_factor_9.svg")
```
...
```{r out.width = "100%"}
knitr::include_graphics("figs/cirgo_large_factor_11.svg")
```
...
```{r out.width = "100%"}
knitr::include_graphics("figs/cirgo_large_factor_13.svg")
```
...
```{r out.width = "100%"}
knitr::include_graphics("figs/cirgo_large_factor_14.svg")
```
...
```{r out.width = "100%"}
knitr::include_graphics("figs/cirgo_large_factor_17.svg")
```
...
```{r out.width = "100%"}
knitr::include_graphics("figs/cirgo_large_factor_18.svg")
```
...
```{r out.width = "100%"}
knitr::include_graphics("figs/cirgo_large_factor_19.svg")
```
...
```{r out.width = "100%"}
knitr::include_graphics("figs/cirgo_large_factor_20.svg")
```
