...
```{r dge_comparison, fig.height=7, fig.width=10, eval=FALSE, include=FALSE}
...
```{r gsfa_barplot_selected, fig.width=10, fig.height=14}
...
# marker_indx <- c("ARID1A", "CBLB", "CD3D", "CD5", "DGKA", "LCP2", "RASA2", "TCEB2")
