...
```{r}
All_KOs.gibbs_PM <-
  readRDS(paste0(wkdir, "gsfa_output_top8k_var/All_KOs.corrected.gibbs_obj_k20.svd.PM.rds"))
...
```{r}
gsfa.go_enrich <-
  readRDS(paste0(wkdir, "gsfa_output_top8k_var/enrich_res/All_KOs.corrected.k20_svd.go_enrich.cutoff_0.9.rds"))
print_enrich_tb(gsfa.go_enrich)
```
