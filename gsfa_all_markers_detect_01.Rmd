...
rand_1.gibbs_PM <- readRDS(paste0(wkdir,
                                  "gsfa_output_detect_01/All.corrected.gibbs_obj_k20.rand_01.PM.rds"))
rand_2.gibbs_PM <- readRDS(paste0(wkdir,
                                  "gsfa_output_detect_01/All.corrected.gibbs_obj_k20.rand_02.PM.rds"))
G0.gibbs_PM <-  readRDS(paste0(wkdir,
                               "gsfa_output_detect_01/G0.corrected.gibbs_obj_k20.svd.PM.rds"))
```
