...
````{r}
flashier_obj <- readRDS(paste0(wkdir, "flash_output/top8k_var.corrected.flashier_obj_k20.rds"))
...
flash.go_enrich <- readRDS(paste0(wkdir,
                                 "flash_output/enrich_res/top8k_var.corrected.flash_k20.go_enrich.rds"))
