...
```{r}
gibbs_PM <-
  readRDS(paste0(wkdir, "gsfa_output_detect_01/TP53.corrected.gibbs_obj_k20.svd.PM.rds"))
...
```{r}
rand_1.gibbs_PM <-
  readRDS(paste0(wkdir, "gsfa_output_detect_01/TP53.corrected.gibbs_obj_k20.rand_01.PM.rds"))
...
## Permutation test on associations

[Permutation results for all methods](permutation.html).
