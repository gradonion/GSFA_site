...
```{r}
G0.gibbs_PM <-  readRDS(paste0(wkdir, "gsfa_output_top10k_var/G0.corrected.gibbs_obj_k20.svd.PM.rds"))
...
```{r}
G0.go_enrich <-
  readRDS(paste0(wkdir, "gsfa_output_top10k_var/enrich_res/G0.corrected.k20_svd.go_enrich.cutoff_0.5.rds"))
