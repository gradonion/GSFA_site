...
````{r}
flashier_obj <- readRDS(paste0(wkdir, "flash_output/detect_0.1.corrected.flashier_obj_k20.rds"))
...
flash.go_enrich <- readRDS(paste0(wkdir,
                                 "flash_output/enrich_res/detect_0.1.corrected.flash_k20.go_enrich.rds"))
